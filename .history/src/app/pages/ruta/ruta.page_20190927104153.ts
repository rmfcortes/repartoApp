...
export class RutaPage implements OnInit, OnDestroy {
  ...
  pedidosNoAsignados() {
    ...
    this.pedidosNot =  this.clienteService.hayPedidosNot().subscribe((pedidosNot: any) => {
        this.mensajes = pedidosNot;
    });
  }
  ...
  ngOnDestroy(): void {
    ...
    if (this.pedidosNot) { this.pedidosNot.unsubscribe(); }
