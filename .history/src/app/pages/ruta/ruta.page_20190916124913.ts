...
import { Cliente } from '../../../../.history/src/app/interfaces/compra.interface_20190916120648';
...
export class RutaPage implements OnInit, OnDestroy {
  ...
  async pedidosPendientes() {
    const resp: Cliente[] = await this.ventaService.revisaPedidos();
    this.clientes = Object.values(resp);
  }

  esuchcaPedidos() {
    this.notificationService.clientesObs.subscribe((clientes: Cliente[]) => {
